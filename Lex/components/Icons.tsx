...
export const WaterDropIcon = ({ className }: IconProps) => (
...
export const ThumbUpIcon = ({ className }: IconProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M14 10h4.764a2 2 0 011.789 2.894l-3.5 7A2 2 0 0115.263 21h-4.017c-.163 0-.326-.02-.485-.06L7 20m7-10V5a2 2 0 00-2-2h-.085a2 2 0 00-1.736.923L5.5 8m7 2v5m0 0v-5m0 5H9.828a2 2 0 01-1.789-2.894l3.5-7a2 2 0 011.789-1.106h4.017c.886 0 1.628.59 1.895 1.441l.556 1.947m-6.443 4.286a.75.75 0 01-1.06 0l-1.06-1.06a.75.75 0 010-1.061l1.06-1.06a.75.75 0 011.06 0l1.06 1.06a.75.75 0 010 1.06z" />
    </svg>
);

export const ArrowUturnUpIcon = ({ className }: IconProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
...
export const UsersIcon = ({ className }: IconProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm6-11a3 3 0 100-6 3 3 0 000 6zM21 21h-3v-1a6 6 0 00-6-6H9" />
    </svg>
);
...
export const PlayTriangleIcon = ({ className }: IconProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 20 20" fill="currentColor">
        <path d="M6.3 2.841A1.5 1.5 0 004 4.11V15.89a1.5 1.5 0 002.3 1.269l9.344-5.89a1.5 1.5 0 000-2.538L6.3 2.84z" />
    </svg>
);

export const DocumentDownloadIcon = ({ className }: IconProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
...
export const SparklesIcon = ({ className }: IconProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M5 3v4M3 5h4M6 17v4m-2-2h4m5-16l2.293 2.293a1 1 0 010 1.414l-2.293 2.293m0-4.001l2.293-2.293a1 1 0 000-1.414l-2.293-2.293m-1.414 4.001l-2.293 2.293a1 1 0 01-1.414 0l-2.293-2.293m4.001 1.414l-2.293-2.293a1 1 0 00-1.414 0l-2.293 2.293m-1.414 4.001l2.293 2.293a1 1 0 010 1.414l-2.293 2.293m0-4.001l2.293-2.293a1 1 0 000-1.414l-2.293-2.293m1.414 4.001l-2.293 2.293a1 1 0 01-1.414 0l-2.293-2.293" />
    </svg>
);

export const ShieldCheckIcon = ({ className }: IconProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 20.944a12.02 12.02 0 0018 0a12.02 12.02 0 00-3.382-15.016z" />
    </svg>
);
...
export const TrophyIcon = ({ className }: IconProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M9 11l3-3m0 0l3 3m-3-3v8m0-13a9 9 0 110 18 9 9 0 010-18zm0 0c-1.657 0-3 .895-3 2s1.343 2 3 2 3-.895 3-2-1.343-2-3-2zM9 12a3 3 0 116 0 3 3 0 01-6 0z" />
    </svg>
);
...
export const FireIcon = ({ className }: IconProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        ...
        <path strokeLinecap="round" strokeLinejoin="round" d="M9.536 17.657l-1.06-1.06A8 8 0 018 5.436l1.06 1.06m5.658 5.656l-1.06 1.06A8 8 0 0016 8.564l1.06-1.06m-5.657 5.657l-1.06 1.06" />
    </svg>
);

export const CheckBadgeIcon = ({ className }: IconProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 20 20" fill="currentColor">
        <path fillRule="evenodd" d="M6.267 3.455a3.066 3.066 0 001.745-.723 3.066 3.066 0 013.976 0 3.066 3.066 0 001.745.723 3.066 3.066 0 012.812 2.812c.051.643.304 1.254.723 1.745a3.066 3.066 0 010 3.976 3.066 3.066 0 00-.723 1.745 3.066 3.066 0 01-2.812 2.812 3.066 3.066 0 00-1.745.723 3.066 3.066 0 01-3.976 0 3.066 3.066 0 00-1.745-.723 3.066 3.066 0 01-2.812-2.812 3.066 3.066 0 00-.723-1.745 3.066 3.066 0 010-3.976 3.066 3.066 0 00.723-1.745 3.066 3.066 0 012.812-2.812zm3.839 6.22a.75.75 0 10-1.06-1.06L9 9.94 7.53 8.47a.75.75 0 00-1.06 1.06L8.47 11l-1.94 1.94a.75.75 0 001.06 1.06L10 12.06l1.47 1.47a.75.75 0 001.06-1.06L11.06 11l1.94-1.94z" clipRule="evenodd" />
    </svg>
);
...
export const BrainCircuitIcon = ({ className }: IconProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M8.25 7.5l.415-.415a.487.487 0 01.688 0l.415.415m-1.518 0l.415.415a.487.487 0 00.688 0l.415-.415m-1.518 0l.415-.415m0 0l.415.415m0 0l.415-.415M12 9.75a3 3 0 100-6 3 3 0 000 6zm0 0a3 3 0 100 6 3 3 0 000-6zm0 0a3 3 0 106 0 3 3 0 00-6 0zm0 0a3 3 0 10-6 0 3 3 0 006 0zm0 0v3.75m-3.75 0v-3.75m7.5 0v3.75" />
    </svg>
);
...
export const BookmarkSlashIcon = ({ className }: IconProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M5 5a2 2 0 012-2h10a2 2 0 012 2v16l-7-3.5L5 21V5z" />
