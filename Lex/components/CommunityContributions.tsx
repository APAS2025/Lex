...
const CommunityContributions = ({ initialComments, initialDocuments }: CommunityContributionsProps) => {
    ...
    const TabButton = ({ tab, label, icon, count }: {tab: 'comments' | 'documents', label: string, icon: React.ReactNode, count: number}) => (
        <button
