...
import { manuals, vendors } from '../data/mockData';
...
const ManualDetail: React.FC = () => {
    ...
    const manual = useMemo(() => manuals.find(m => m.id === manualId), [manualId]);
    const vendor = useMemo(() => manual ? vendors.find(v => v.id === manual.vendorId) : undefined, [manual]);
