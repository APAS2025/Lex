...
const EcosystemDirectory: React.FC = () => {
    ...
    const FilterButton: React.FC<{ type: EntityType | null, label: string, icon: React.FC<{className?: string}> }> = ({ type, label, icon: Icon }) => {
